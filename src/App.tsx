  ...
  return (
    <div className="fixed inset-0 bg-[#020617] text-white font-sans overflow-hidden select-none">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-tr from-[#0c0a09] via-[#1e1b4b] to-[#4338ca] opacity-40"></div>
    ...
    <div className="absolute top-0 left-0 w-full p-8 flex justify-between items-start pointer-events-none z-[60]">
      <div className="flex gap-4">
        <div className="w-16 h-16 rounded-full frosted-glass flex items-center justify-center p-1 border-white/30">
          <div className="w-full h-full rounded-full bg-gradient-to-b from-indigo-400 to-purple-600 flex items-center justify-center font-black italic text-xl shadow-inner">
        ...
        <div className="flex flex-col justify-center gap-1">
          ...
          <div className="flex items-center gap-2 mt-1">
            <div className="h-2 w-48 bg-black/40 rounded-full overflow-hidden border border-white/10">
              <motion.div 
                className="h-full bg-gradient-to-r from-red-500 to-orange-400 shadow-[0_0_10px_rgba(239,68,68,0.5)]" 
                initial={{ width: 0 }}
      ...
      <div className="text-right">
        <h3 className="text-3xl font-black italic tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white to-white/40 leading-none">
          {scene.replace('-', ' ')}
        </h3>
